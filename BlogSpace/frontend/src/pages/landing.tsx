    ...
    return (
        <div className="bg-purple-100 h-screen">
            ...
            <div className="flex flex-row absolute top-0 right-0 mr-36 pt-8">
                ...
                <button className="hover:text-slate-500 font-sans text-lg mt-3 underline underline-offset-1">Sign in</button>
                <button type="button" className="py-2.5 px-5 me-2 mb-2 text-white text-sm rounded-full border hover:bg-slate-600 focus:z-10 dark:bg-black font-sans mx-4 mt-4">Get Started</button>
            </div>
            <div className="flex flex-col pt-36">
                ...
                <div className="flex pl-36 pt-5">   
                    <button type="button" className="py-2.5 px-5 me-2 mb-2 text-lg text-white  rounded-full border hover:bg-slate-600 focus:z-10 dark:bg-black font-sans mx-4 mt-5 "
